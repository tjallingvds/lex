...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/components/plate-ui/sheet"
import { Skeleton } from "@/components/plate-ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "first:data-[side=left]:cursor-w-resize first:data-[side=right]:cursor-e-resize",
